...
def movieID_to_Title(MID):
    title = (movies.loc[movies.movieId == MID, ['title'][0]].values[0][0:-7])
...
def get_result(a):
    result1 = (((get_movie_recommendation((movieID_to_Title(a[0])))).Title.tolist()))

    result2 = (((get_movie_recommendation((movieID_to_Title(a[1])))).Title.tolist()))

    result3 = (((get_movie_recommendation((movieID_to_Title(a[2])))).Title.tolist()))
